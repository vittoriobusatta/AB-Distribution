...
function LandingHandwash() {
  return (
    <LandingWrap>
      <LandingContent>
        <LandingTitle className="title_handwash">Handwash</LandingTitle>

        <LandingDescription>
          <LandingParagraph>
            Une bonne hygiène des mains est importante pour tout le monde. Il
            est important de se laver les mains plusieurs fois par jour. Dans
            cette catégorie, vous retrouverez des savons liquides pour les mains
            sèches aux senteurs fruitées.
          </LandingParagraph>
        </LandingDescription>
      </LandingContent>
