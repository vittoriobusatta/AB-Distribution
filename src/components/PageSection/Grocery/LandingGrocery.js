...
function LandingGrocery() {
  return (
    <LandingWrap>
      <LandingContent>
        <LandingTitle className="title_grocery">Grocery</LandingTitle>

        <LandingDescription>
          <LandingParagraph>
            Nous proposons un large éventail de produits alimentaires de la
            marque Tukas tels que des produits en conserve, des légumes marinés,
            des confitures et sauces . Découvrez nos sélections !
          </LandingParagraph>
        </LandingDescription>
      </LandingContent>
