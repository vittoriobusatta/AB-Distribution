...
function LandingCoffee() {
  return (
    <LandingContainer>
      <LandingWrap>
        <LandingContent>
          <LandingBox>
            <LandingTitle className="title_coffee">Coffee</LandingTitle>
          </LandingBox>
          ...
          <LandingDescription>
            <LandingParagraph>
              ...
              spécialement sélectionnés pour vous permettre de vous sentir mieux.
            </LandingParagraph>
          </LandingDescription>
        </LandingContent>
