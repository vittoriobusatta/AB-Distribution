...
function LandingShowergel() {
  return (
    <LandingWrap>
      <LandingContent>
        <LandingTitle className="title_showergel">Showergel</LandingTitle>

        <LandingDescription>
          <LandingParagraph>
            Un gel douche est un type de savon conçu pour être utilisé sous la
            douche ou dans le bain. Notre gamme de gel douche Ultra Compact au
            pH neutre qui contient ni paraben, ni alcool, ni silicone et enrichi
            en huiles naturelles sera idéal pour vous. dessécher.
          </LandingParagraph>
        </LandingDescription>
      </LandingContent>
...
export default LandingShowergel;
