    ...
    <LandingContainer>
      <LandingWrap>
        <LandingContent>
          ...
          <LandingDescription>
            <LandingParagraph>
              Nos parfums d’ambiance Ultra Compact peuvent donner vie à votre décoration et à votre maison en
              amenant une dimension sensorielle toute particulière. Ils vous permettront de créer une nouvelle atmosphère
              intérieure parfumée en un tour de main.
            </LandingParagraph>
          </LandingDescription>
        </LandingContent>
